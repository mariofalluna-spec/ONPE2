...
export const QuickActions: React.FC = () => {
  ...
  // 1. 31 Distritos
  // 2. Responsables (renombrado en vez de "Coord.")
  // 3. Mesas
  // 4. Asignados
  // Opción "Miembros": ANULADA
  ...
  return (
    <div className="w-full px-3 py-0.5">
      {/* Ultra-Slim Navigation Bar con distribución de 4 columnas */}
      <div className="grid grid-cols-4 gap-1 p-0.5 rounded-xl bg-black/25 backdrop-blur-md border border-white/20 shadow-xs">
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center justify-center gap-1 py-1 px-1 rounded-lg transition-all duration-150 active:scale-95 text-center leading-none ${
                isActive
